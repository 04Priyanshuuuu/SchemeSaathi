          ...
          <div className="grid lg:grid-cols-2 items-center gap-12">
            ...
            <div>
              ...
              <p className="mt-7 max-w-lg text-gray-300 text-base lg:text-lg leading-relaxed">
                YojnaSetu helps you discover suitable financial assistance
                schemes, understand your eligibility, calculate EMI and connect
                with nearby channel partners.
              </p>

              <button
                onClick={() => goTo("#/schemes")}
                className="mt-9 w-full max-w-[600px] h-14 rounded-full bg-[#B9E92F] text-[#091928] font-bold text-base lg:text-lg shadow-[0_5px_12px_rgba(0,0,0,0.35)] hover:scale-[1.02] transition cursor-pointer"
              >
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-gray-600 leading-relaxed">
              YojnaSetu is a platform designed to make financial assistance
              schemes easier to discover and understand. We bring scheme
              discovery, personalised recommendations, EMI calculation and
              partner discovery together in one place.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-14">
            <div className="rounded-3xl bg-[#effbd9] border border-[#d5ed8d] p-8">
              ...
              <h3 className="text-xl font-bold mt-6">Easy Scheme Discovery</h3>

              <p className="text-gray-600 text-sm leading-relaxed mt-3">
                Find financial assistance schemes without having to search
            ...
            <div className="rounded-3xl bg-[#effbd9] border border-[#d5ed8d] p-8">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mt-3">
                Get recommendations based on your profile, requirements and
            ...
            <div className="rounded-3xl bg-[#effbd9] border border-[#d5ed8d] p-8">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mt-3">
                Find suitable channel partners and know where to take the next
                step with your application.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#edf9d4] text-[#091928] py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center">
            <p className="text-[#8ba918] font-semibold">Our Features</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 mt-14">
            ...
            >
              ...
              <h3 className="font-bold text-lg mt-5">Search Schemes</h3>

              <p className="text-gray-600 text-sm mt-3 leading-relaxed">
                Search and explore financial assistance schemes available for
            ...
            >
              ...
              <h3 className="font-bold text-lg mt-5">Scheme Recommendation</h3>

              <p className="text-gray-600 text-sm mt-3 leading-relaxed">
                Provide your information and discover schemes that may suit your
                needs.
              </p>
            ...
            >
              ...
              <h3 className="font-bold text-lg mt-5">EMI Calculator</h3>

              <p className="text-gray-600 text-sm mt-3 leading-relaxed">
                Estimate your repayment amount and understand your financial
                commitment.
              </p>
            ...
            >
              ...
              <h3 className="font-bold text-lg mt-5">Find Partners</h3>

              <p className="text-gray-600 text-sm mt-3 leading-relaxed">
                Locate nearby channel partners who can help you proceed further.
              </p>
      ...
      <section className="bg-white text-[#091928] py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-[#8ba918] font-semibold">Simple & Transparent</p>

            <h2 className="text-4xl font-bold mt-2">How YojnaSetu Helps You</h2>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-bold mt-5">Tell Us Your Need</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold mt-5">Discover Schemes</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold mt-5">Understand Your Options</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold mt-5">Connect & Proceed</h3>
      ...
      <section className="bg-[#091928] py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-300 mt-5">
            Find the right scheme, understand your options and take the next
